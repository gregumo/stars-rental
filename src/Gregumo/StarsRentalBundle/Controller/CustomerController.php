...
use Gregumo\StarsRentalBundle\Form\CustomerType;
...
class CustomerController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GregumoStarsRentalBundle:Customer')->findAll();
     ...
     * @Method("POST")
     * @Template("GregumoStarsRentalBundle:Customer:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GregumoStarsRentalBundle:Customer')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("GregumoStarsRentalBundle:Customer:edit.html.twig")
     */
