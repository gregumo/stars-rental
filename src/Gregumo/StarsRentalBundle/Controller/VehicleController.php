...
use Gregumo\StarsRentalBundle\Form\VehicleType;
...
class VehicleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GregumoStarsRentalBundle:Vehicle')->findAll();
     ...
     * @Method("POST")
     * @Template("GregumoStarsRentalBundle:Vehicle:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GregumoStarsRentalBundle:Vehicle')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("GregumoStarsRentalBundle:Vehicle:edit.html.twig")
     */
